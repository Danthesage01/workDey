    ...
    <View style={styles.container}>
      <View style={styles.inputContainer}>
        ...
        <View style={styles.textPureContainer}>
          <Text>Title(25 char)</Text>
          <TextInput
            style={styles.input}
            autoCapitalize="sentences"
            keyboardType="default"
            onChangeText={(text) => handleChange(text, "mobileNumber")}
            placeholder="I need s Mechanic to fix car"
            value={mobileNumber}
          />
        </View>
        <View style={styles.textPureContainer}>
          ...
          <TextInput
            ...
            onChangeText={(text) => handleChange(text, "mobileNumber")}
            placeholder="I need a Mechanic to fix car"
            value={mobileNumber}
          />
        </View>
        ...
        <View style={[styles.row, styles.rowRating]}>
          <Pressable
            style={[styles.row, styles.textInputName, styles.view_date]}
          >
            <Image source={require("../../../../assets/date.png")} />
            <Text style={{ color: "#ccc" }}>Date</Text>
          </Pressable>
          <Pressable
            style={[styles.row, styles.textInputName, styles.view_time]}
          >
            <Image source={require("../../../../assets/timer.png")} />
            <Text>Select Time</Text>
          </Pressable>
        </View>
        <Text>Upload Pictures(optional)</Text>
        <View style={styles.textNameContainer}>
          <TextInput
            style={styles.textInputName}
            placeholder="select category"
        ...
        <View style={styles.textPureContainer}>
          <Text>Upload Video(optional)</Text>
          <TextInput
            style={styles.input}
            autoCapitalize="sentences"
            keyboardType="default"
